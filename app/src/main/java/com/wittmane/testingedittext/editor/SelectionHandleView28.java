...
public class SelectionHandleView28 extends HandleView28 {
    ...
    public SelectionHandleView28(Drawable drawableLtr, Drawable drawableRtl, int id,
                               @HandleType int handleType, CustomEditTextView textView) {
        super(drawableLtr, drawableRtl, id, textView);
    ...
    protected void updatePosition(float x, float y, boolean fromTouchScreen) {
        ...
        final int wordEnd = mTextView.mEditor.getWordEnd(offset);
        final int wordStart = mTextView.mEditor.getWordStart(offset);
...
//        final boolean isLvlBoundary = layout.isLevelBoundary(offset);
    ...
    protected void positionAtCursorOffset(int offset, boolean forceUpdatePosition,
        ...
        mInWord = (offset != -1) && !mTextView.mEditor.getWordIteratorWithText().isBoundary(offset);
    }
...
//                    }
            ...
            offset = mTextView.mEditor.getNextCursorOffset(anotherHandleOffset, !isStartHandle());
        }
        positionAtCursorOffset(offset, false, fromTouchScreen);
    }
