...
public class SimpleTouchManager {
    ...
    // return if touch even should continue to be processed
    //TODO: maybe return if the event was handled
...
//                    startSelectionActionModeAsync(mHaventMovedEnoughToStartDrag);
                ...
                if (mDiscardNextActionUp) {
                    ...
                    //TODO: TextView still did some stuff with this, so maybe something more need to be done here
//                    if (mEditor.mIsInsertionActionModeStartPending) {
//                        mEditor.startInsertionActionMode();
//                        mEditor.mIsInsertionActionModeStartPending = false;
//                    }
                    //TODO: should this have blocked the drag accelerator stuff?
                    break;
                }
                final boolean touchIsFinished = !mIgnoreActionUpEvent && mTextView.isFocused();
                if (touchIsFinished) {
                    mTextView.onTouchFinished();

                    //TODO: continue adding the contents of Editor#onTouchUpEvent
...
//                            }
                            //TODO: this wasn't here originally, but it might be necessary (for now)
