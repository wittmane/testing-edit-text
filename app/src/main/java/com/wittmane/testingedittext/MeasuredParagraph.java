...
//
//import com.wittmane.testingedittext.AutoGrowArray.ByteArray;
//
...
//    private @/*Layout*/HiddenLayoutInfo.Direction int mParaDir;
//
...
//     * This is always available.
//     */
//    public @/*Layout*/HiddenLayoutInfo.Direction int getParagraphDir() {
//        return mParaDir;
//    }
//
//    /**
...
//     * This is always available.
//     */
//    public /*Layout*/HiddenLayoutInfo.Directions getDirections(@IntRange(from = 0) int start,  // inclusive
...
//            if (textDir == TextDirectionHeuristics.LTR) {
//                bidiRequest = /*Layout*/HiddenLayoutInfo.DIR_REQUEST_LTR;
//            } else if (textDir == TextDirectionHeuristics.RTL) {
//                bidiRequest = /*Layout*/HiddenLayoutInfo.DIR_REQUEST_RTL;
//            } else if (textDir == TextDirectionHeuristics.FIRSTSTRONG_LTR) {
//                bidiRequest = /*Layout*/HiddenLayoutInfo.DIR_REQUEST_DEFAULT_LTR;
//            } else if (textDir == TextDirectionHeuristics.FIRSTSTRONG_RTL) {
//                bidiRequest = /*Layout*/HiddenLayoutInfo.DIR_REQUEST_DEFAULT_RTL;
//            } else {
//                final boolean isRtl = textDir.isRtl(mCopiedBuffer, 0, mTextLength);
//                bidiRequest = isRtl ? /*Layout*/HiddenLayoutInfo.DIR_REQUEST_RTL : /*Layout*/HiddenLayoutInfo.DIR_REQUEST_LTR;
//            }
...
//    /* package */ static boolean doesNotNeedBidi(char[] text, int start, int len) {
