...
public abstract class CustomMetaKeyKeyListener {
     ...
     */
    public static final int META_CAP_LOCKED = /*KeyEvent.META_CAP_LOCKED*/0x100;
    /**
     * Flag that indicates that the ALT key is locked.
     */
    public static final int META_ALT_LOCKED = /*KeyEvent.META_ALT_LOCKED*/0x200;
    /**
     * Flag that indicates that the SYM key is locked.
     */
    public static final int META_SYM_LOCKED = /*KeyEvent.META_SYM_LOCKED*/0x400;
