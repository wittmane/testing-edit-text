...
/**
 * Base adapter for a {@link ListView} to allow dragging to reorder objects in the list. Items can
 * be moved by using a drag handle or a long press.
 * @param <TListItems> Object type for the main list items.
...
public abstract class DraggableListAdapterBase<TListItems, TListItemBuilder> extends BaseAdapter {
    ...
    protected final TListItemBuilder mListItemBuilder;
    ...
    /**
     * Create a {@link DraggableListAdapterBase} using the default view, which uses the specified
     ...
     */
    public DraggableListAdapterBase(Context context, TListItemBuilder listItemBuilder) {
        this(context, R.layout.draggable_row, R.id.dragHandle, listItemBuilder);
    }

    /**
     * Create a {@link DraggableListAdapterBase} using a custom view
     * @param context The current context.
    ...
    protected abstract void updateView(View view, int index);
    /**
