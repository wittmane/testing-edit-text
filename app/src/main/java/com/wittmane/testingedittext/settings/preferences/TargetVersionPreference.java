...
public class TargetVersionPreference extends PerTestFieldPreference {

    public TargetVersionPreference(Context context) {
        super(context);
        init();
    }
    ...
    public TargetVersionPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        setFragment(TargetVersionSettingsFragment.class.getName());
    }
    ...
    protected void updateDisplayText() {
        ...
        if (groupIndex != -1 && fieldIndex != -1) {
            ...
            setSummary(getContext().getString(fieldSettings.overridesTargetVersion()
