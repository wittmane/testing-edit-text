...
public class ModifyTextPreference extends PerTestFieldPreference {

    public ModifyTextPreference(Context context) {
        super(context);
        init();
    }
    ...
    public ModifyTextPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        setFragment(ModifyTextSettingsFragment.class.getName());
    }
    ...
    protected void updateDisplayText() {
        ...
        if (groupIndex != -1 && fieldIndex != -1) {
            ...
            setSummary(getContext().getString(fieldSettings.overridesTextInputModification()
