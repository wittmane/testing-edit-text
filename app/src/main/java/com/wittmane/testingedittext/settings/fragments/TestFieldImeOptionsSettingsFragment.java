...
public class TestFieldImeOptionsSettingsFragment extends TestFieldBaseSettingsFragment {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.preference_screen_test_field_ime_options);
