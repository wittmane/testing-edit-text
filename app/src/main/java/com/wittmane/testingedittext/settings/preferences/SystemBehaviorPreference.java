...
public class SystemBehaviorPreference extends PerTestFieldPreference {

    public SystemBehaviorPreference(Context context) {
        super(context);
        init();
    }
    ...
    public SystemBehaviorPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        setFragment(SystemBehaviorSettingsFragment.class.getName());
    }
    ...
    protected void updateDisplayText() {
        ...
        if (groupIndex != -1 && fieldIndex != -1) {
            ...
            setSummary(getContext().getString(fieldSettings.overridesSystemBehavior()
