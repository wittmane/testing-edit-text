...
public class ComposingTextPreference extends PerTestFieldPreference {

    public ComposingTextPreference(Context context) {
        super(context);
        init();
    }
    ...
    public ComposingTextPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        setFragment(ComposingTextSettingsFragment.class.getName());
    }
    ...
    protected void updateDisplayText() {
        ...
        if (groupIndex != -1 && fieldIndex != -1) {
            ...
            setSummary(getContext().getString(fieldSettings.overridesTextComposition()
