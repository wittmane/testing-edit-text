...
//                HiddenTextUtils.doesNotNeedBidi(mChars, 0, len)) {
...
//                //TODO: (EW) is this right? I don't think this is actually called in P and later
//                // (not certain when the change happened). probably should match current
