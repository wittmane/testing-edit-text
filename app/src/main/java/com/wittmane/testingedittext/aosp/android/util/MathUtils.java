...
// (EW) the AOSP version of this is hidden from apps, so it had to be copied here. it does have a
// comment saying it is pending API council approval, so maybe we'll eventually be able to use the
// real version.
/**
