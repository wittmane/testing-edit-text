...
//        mEditor = Preconditions.checkNotNull(editor);
        ...
        mTextClassificationHelper = new TextClassificationHelper(
                ...
                getText(mTextView),
                0, 1,
                Build.VERSION.SDK_INT >= Build.VERSION_CODES.N ? mTextView.getTextLocales() : null);
...
//                    Preconditions.checkArgumentInRange(end, start, mText.length(), "end");
        ...
        private boolean hasActiveClassificationSession() {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                ...
                //TODO: (EW) handle?
                return mClassificationSession != null;
            }
        }
...
//            mSelectionResultSupplier = Preconditions.checkNotNull(selectionResultSupplier);
            mSelectionResultSupplier = selectionResultSupplier;
//            mSelectionResultCallback = Preconditions.checkNotNull(selectionResultCallback);
            mSelectionResultCallback = selectionResultCallback;
//            mTimeOutResultSupplier = Preconditions.checkNotNull(timeOutResultSupplier);
            mTimeOutResultSupplier = timeOutResultSupplier;
