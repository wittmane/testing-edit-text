...
package com.wittmane.testingedittext.aosp.android.text.style;
...
public class SpanUtils {
    ...
    private static <T> boolean isCovered(@NonNull Spannable spannable, @NonNull List<T> spans,
        ...
        // (EW) the AOSP version used LongArray, which is hidden and is just a growing array of long
        // primitives, so I just changed it to an ArrayList to not bother pulling in that class for
        // likely negligible benefit.
        ArrayList<Long> uncoveredRanges = new ArrayList<>();
        ArrayList<Long> nextUncoveredRanges = new ArrayList<>();
        ...
        for (int si = 0; si < spans.size(); ++si) {
            ...
            final ArrayList<Long> tmp = nextUncoveredRanges;
