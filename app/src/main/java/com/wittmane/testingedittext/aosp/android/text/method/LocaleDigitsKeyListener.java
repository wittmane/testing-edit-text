...
/**
 * (EW) Simple extension of DigitsKeyListener (for digits-only text entry) that only supports the
 * variant that includes the locale (ie not string mode) to allow creating a copy with a different
 * locale. This is just a copy of a small bit of DigitsKeyListener to get
