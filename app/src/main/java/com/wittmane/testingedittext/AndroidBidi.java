...
//import com.wittmane.testingedittext.HiddenLayoutInfo.Directions;
//
///**
...
//        switch (dir) {
//            case /*Layout*/HiddenLayoutInfo.DIR_REQUEST_LTR: paraLevel = Bidi.LTR; break;
//            case /*Layout*/HiddenLayoutInfo.DIR_REQUEST_RTL: paraLevel = Bidi.RTL; break;
//            case /*Layout*/HiddenLayoutInfo.DIR_REQUEST_DEFAULT_LTR: paraLevel = Bidi.LEVEL_DEFAULT_LTR; break;
//            case /*Layout*/HiddenLayoutInfo.DIR_REQUEST_DEFAULT_RTL: paraLevel = Bidi.LEVEL_DEFAULT_RTL; break;
...
//        return (result & 0x1) == 0 ? /*Layout*/HiddenLayoutInfo.DIR_LEFT_TO_RIGHT : /*Layout*/HiddenLayoutInfo.DIR_RIGHT_TO_LEFT;
//    }
//
//    /**
...
//        if (len == 0) {
//            return /*Layout*/HiddenLayoutInfo.DIRS_ALL_LEFT_TO_RIGHT;
//        }
//
//        int baseLevel = dir == /*Layout*/HiddenLayoutInfo.DIR_LEFT_TO_RIGHT ? 0 : 1;
...
//            if ((minLevel & 1) != 0) {
//                return /*Layout*/HiddenLayoutInfo.DIRS_ALL_RIGHT_TO_LEFT;
//            }
//            return /*Layout*/HiddenLayoutInfo.DIRS_ALL_LEFT_TO_RIGHT;
//        }
//
...
//        int levelBits = minLevel << /*Layout*/HiddenLayoutInfo.RUN_LEVEL_SHIFT;
//        {
...
//                    ld[n++] = i - lstart;
//                    levelBits = curLevel << /*Layout*/HiddenLayoutInfo.RUN_LEVEL_SHIFT;
//                    prev = i;
//                }
//            }
...
//            if (visLen < len) {
//                ld[++n] = visLen;
//                ld[++n] = (len - visLen) | (baseLevel << /*Layout*/HiddenLayoutInfo.RUN_LEVEL_SHIFT);
//            }
//        }
//
